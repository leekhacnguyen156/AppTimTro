...
public class PhongDaDangApdater extends BaseAdapter {

    private final ArrayList<mTin> armTin;
    private final Context context;
    private final int layout;

    public PhongDaDangApdater(ArrayList<mTin> armTin,  Context context, int layout){
        this.armTin = armTin;
    ...
    private class ViewHolder {
        ImageView imgAnhMinhHoaTinDaDang, trangthai;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.trangthai = convertView.findViewById(R.id.imgTrangthaiPhongdadang);
        ...
        if (armTin.get(position).getTrangthaiduyet().equals("0")){
            viewHolder.trangthai.setImageResource(R.drawable.ic_choduyet);
        }else if (armTin.get(position).getTrangthaiduyet().equals("1")){
            viewHolder.trangthai.setImageResource(R.drawable.ic_duyet);
        }else{
            viewHolder.trangthai.setImageResource(R.drawable.ic_khongduyet);
        }
